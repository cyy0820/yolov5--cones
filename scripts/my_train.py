...
def main():
    ...
    parser.add_argument('--cfg', type=str, default=os.path.abspath('../yolov5/models/yolov5s.yaml'))
    parser.add_argument('--weights', type=str, default=os.path.abspath('../models/cone_model3.pt'))
    ...
    parser.add_argument('--hyp', type=str, default=os.path.abspath('../yolov5/data/hyps/hyp.scratch-low.yaml'))
